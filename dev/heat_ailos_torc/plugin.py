...
class HeatAilosTorcPlugin(FusePlugin):
    ...
    def setup(self, ctx: FuseContext) -> None:
        ...
        if mode == "predictor":
            from heat_ailos_torc.predictor.main import open_overlay
            ...
            from heat_ailos_torc.trainer.main import open_overlay
            self._overlay = open_overlay(ctx.tk_root, profile, fuse_config=ctx.config)
        elif mode == "refiner":
            from heat_ailos_torc.refiner.main import open_editor
    ...
    def _pick(self, ctx: FuseContext):
        ...
        from heat_ailos_torc.runner import _build_picker_dialog
