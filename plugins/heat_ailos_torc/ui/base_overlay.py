...
from heat_ailos_torc.ocr.rangefinder_ui import RangefinderUiMixin
from heat_ailos_torc.ui.hud_ui import HudUiMixin
    ...
    def _read_range_value(self):
        ...
        if USE_MEMORY_API:
            ...
            if mem is not None and getattr(mem, "connected", False):
                v = mem.read("multiplayer_hud_rangefinder")
                if v is not None:
                    return float(v)
