...
from fuse.input.hardware_inject_router import inject_mouse_movement, inject_mouse_click, set_cursor_pos
...
def replay_full_scenario(
    ...
    status_callback : callable(str) or None
        Called with status messages. Must be thread-safe (use root.after if
        updating Tk widgets from this callback).
    fire_click : bool
...
__all__ = ["replay_movements", "replay_full_scenario"]
